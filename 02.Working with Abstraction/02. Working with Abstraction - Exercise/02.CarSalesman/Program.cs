...
public class Program
{
    static void Main()
    {
        ...
        engines = FullEngines(engines);
        cars = FullCar(cars, engines);
    ...
    private static List<Car> FullCar(List<Car> cars, List<Engine> engines)
    {
    ...
    private static List<Engine> FullEngines(List<Engine> engines)
    {
